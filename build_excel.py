...
try:
    ...
    # 1. Scale the image
    # A width of ~220-240 is usually perfect to span the center of C and D
    img.width = 230 
    img.height = 75

    # 2. Precise Positioning
    # We anchor to C1, then offset it to the right to reach the "Center" of C
    from openpyxl.drawing.spreadsheet_drawing import AnchorMarker, TwoCellAnchor
    
    # OneCellAnchor or simple anchor with offsets:
    img.anchor = "C1"
    
    # Offset: 1 pixel is roughly 9525 EMUs. 
    # We move it ~120,000 EMUs (about 12-15 pixels) from the left of Column C
    img.marker = AnchorMarker(col=2, colOff=120000, row=0, rowOff=100000) 
