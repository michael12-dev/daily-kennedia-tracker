...
def font(size=11, bold=False, color=BLACK):
    return Font(
        name="Calibri",
        size=size,
        bold=bold,
...
ws["B1"].fill = fill(YELLOW_BOX)
ws["B1"].font = font(size=12, bold=True)
ws["B1"].alignment = align("center", "center")
ws["B1"].border = border()

# =========================
# KENNEDIA LOGO CENTER
# =========================
# Place logo roughly around D1/E1
...
# =========================
# HOW TO COMPLETE TRACKER
# Half of F + full G look
# =========================
ws.merge_cells("F1:G1")

instruction_text = (
    "How to Complete the Tracker:\n\n"
    "Morning 8:00am: Fill your Proposed Tasks + Expected Completion\n"
    "Time\n\n"
    "Evening (At The End Of The Day) 4:00pm:\n"
    "Fill in your completed task and share with your line manager/HOD\n"
    "and upload necessary proof to a shared drive"
)
...
ws["B2"].font = font(size=13, bold=True, color=WHITE)
...
ws["C2"].font = font(size=20, bold=True, color=WHITE)
ws["C2"].alignment = align("center", "center")
ws["C2"].border = border()
...
ws["A3"].fill = fill(GREEN_NAME)
ws["A3"].font = font(size=14, bold=True, color=WHITE)
ws["A3"].alignment = align("center", "center")
ws["A3"].border = border()

ws["B3"] = staff_unit

ws["B3"].fill = fill(GREEN_DARK)
ws["B3"].font = font(size=13, bold=True, color=WHITE)
