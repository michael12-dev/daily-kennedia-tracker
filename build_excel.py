...
# Adjust offsets to center inside C1
# Column C width is ~45 units (from your widths dict)
# Row 1 height is 90
col_width_px = 45 * 7  # Excel column width ≈ 7 pixels per unit
row_height_px = 90     # row height is already in pixels

# Calculate offsets to center
h_offset = pixels_to_EMU((col_width_px - img.width) // 2)
v_offset = pixels_to_EMU((row_height_px - img.height) // 2)

img.anchor._from.colOff = h_offset
img.anchor._from.rowOff = v_offset
